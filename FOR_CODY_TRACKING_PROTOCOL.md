...
**STEP 0: CHECK CURRENT DATE/TIME FIRST** ⚠️ **CRITICAL**
```bash
TZ='Europe/Madrid' date '+%A, %B %d, %Y - %H:%M %Z'
```
- Display the result IMMEDIATELY in response
- Use this EXACT date/time in wrap up title
- DO NOT retype from memory - COPY the output
- Example: "Current time: Saturday, November 22, 2025 - 12:50 CET"
- Then title wrap up: "✅ FULL WRAP UP - Saturday Nov 22, 12:50"

**WHY THIS MATTERS:** Sarah has ADHD time blindness. M has made errors typing wrong dates from memory. Checking and DISPLAYING prevents mistakes.
...
M: [FIRST: Checks date/time]
   TZ='Europe/Madrid' date '+%A, %B %d, %Y - %H:%M %Z'
   → Saturday, November 22, 2025 - 12:50 CET

M: [Displays immediately]
   "Current time: Saturday, November 22, 2025 - 12:50 CET
   
   ✅ FULL WRAP UP - Saturday Nov 22, 12:50"

M: [Then reviews session, updates files, pushes]
